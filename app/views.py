...
from config import *
from . import app, csrf, mongo

from lib.login import login_check
from lib.common import get_project, get_images_details, get_vuln_trend, get_pom_file
...
def images_details():
    ...
    resp = get_images_details(image_id)
    ...
    vuln_trend = get_vuln_trend(resp["project_name"])
    pom_file = get_pom_file(resp["fulltag"])
    if request.path == "/images_details":
